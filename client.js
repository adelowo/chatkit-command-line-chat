...
const main = async () => {
  ...
  try {
    ...
    if (availableRooms.length === 0)
      throw new Error(
        "Couldn't find any available rooms. If you're the developer, go to dash.pusher.com, open your Chatkit instance, and create a room (or two!) using the console tab!"
      );
